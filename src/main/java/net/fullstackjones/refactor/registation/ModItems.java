...
public class ModItems {
    ...
    public static final DeferredItem<Item> COPPERCOIN = ITEMS.register(
            "coppercoin",
            () -> new Item(new Item.Properties().stacksTo(1024)));
    ...
    public static final DeferredItem<Item> RUINEDCOIN = ITEMS.register(
            "ruinedcoin",
            () -> new Item(new Item.Properties().stacksTo(1024)));

    public static final DeferredItem<Item> PURSE = ITEMS.register(
            "purse",
