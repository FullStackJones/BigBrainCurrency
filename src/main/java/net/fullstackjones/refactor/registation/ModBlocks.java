package net.fullstackjones.refactor.registation;
...
import net.fullstackjones.refactor.blocks.BrainBankBlock;
...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> BRAINBANK_BLOCK = registerBlock(
            "brainbank",
    ...
    public static final DeferredBlock<Block> VAULT_BLOCK = registerBlock(
            "vault",
            () -> new Block(BlockBehaviour.Properties.of().sound(SoundType.STONE).strength(2.0f, 2.0f)));

    public static final DeferredBlock<Block> BANK_BLOCK = registerBlock(
            "bank",
            () -> new Block(BlockBehaviour.Properties.of().sound(SoundType.STONE).strength(2.0f, 2.0f)));
