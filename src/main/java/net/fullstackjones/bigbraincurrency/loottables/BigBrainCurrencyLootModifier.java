...
public class BigBrainCurrencyLootModifier extends LootModifier {
    ...
    protected BigBrainCurrencyLootModifier(LootItemCondition[] conditionsIn, double commonChance, double uncommonChance, double rareChance, int commonRolls, int uncommonRolls, int rareRolls) {
        super(conditionsIn);
    ...
    protected ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext context) {
        generatedLoot.addAll(CurrencyLootTables.getRandomRoll(this));
        return generatedLoot;
    }

    public static final MapCodec<BigBrainCurrencyLootModifier> CODEC = RecordCodecBuilder.mapCodec(instance ->
            codecStart(instance)
                    .and(
                            instance.group(
                    ...
                    .apply(instance, BigBrainCurrencyLootModifier::new));

    @Override
    public MapCodec<BigBrainCurrencyLootModifier> codec() {
        return CODEC;
    }
}
